...
const { getAllAdvisors, getAdvisorClients, getAdvisorClientDetails, getDashboardStats, updateAdvisorClient } = require('../controllers/adminController');
...
router.get('/advisors/:advisorId/clients/:clientId', getAdvisorClientDetails);
